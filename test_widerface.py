...
parser.add_argument('--save_folder', default='./retina_widerface_evaluate/widerface_txt/', type=str, help='Dir to save txt results')
parser.add_argument('--cpu', action="store_true", default=False, help='Use cpu inference')
parser.add_argument('--dataset_folder', default='./retina_data/widerface/val/images/', type=str, help='dataset path')
